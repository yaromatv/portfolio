...
export default function ProjectInfo({ project }: ProjectInfoProps) {
  return (
    <div className="flex h-full flex-col items-end justify-start pr-3 text-right">
      ...
      <p className="mt-2 pt-3 text-xs text-neutral-500 dark:text-neutral-400">
        {project.role.join(', ')}
      </p>
      <p className="mt-1 pb-3 text-xs text-neutral-400 dark:text-neutral-500">
        {project.tools.join(', ')}
      </p>
